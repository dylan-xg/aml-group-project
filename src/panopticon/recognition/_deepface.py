...
from deepface.models.FacialRecognition import (
	FacialRecognition as _FacialRecognition
)
...
from ._model import CustomClassifierEmbeddingModel
...
def add_model_to_deepface(model: CustomClassifierEmbeddingModel) -> None:
	class NewModelClient(_FacialRecognition):
...
def custom_normalisation(model) -> None:
	...
	def custom_normalize_input(img, normalization="base"):
		...
		return original_normalise_input(
			img=img,
